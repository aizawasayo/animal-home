    ...
    <template v-slot:default="props">
      <v-row>
        <v-col v-for="item in props.items" :key="item.name" cols="12" sm="6" md="4" lg="3">
          <v-card :href="'/detail/fish/' + item._id">
            ...
            <v-list dense>
              ...
              <v-list-item>
                <v-row>
                  <v-col cols="4" class="py-0"
                    ><v-list-item-content :class="{ 'cyan--text text--lighten-2': options.sortBy === 'rarity' }">稀有度：</v-list-item-content></v-col
                  >
                  <v-col cols="8" class="py-0"
                    ><v-list-item-content class="align-end">{{ item.rarity }}</v-list-item-content></v-col
                  >
                </v-row>
              </v-list-item>
            </v-list>
